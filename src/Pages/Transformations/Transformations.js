...
const Transformations = () => {
  return (
    <div className="transfromations-page">
      ...
      <h4>
        ...
        turn loosing body fat.
        <br />
        <br />
        Each client is assessed at the beginning and at the end of the 10 weeks.
        Our sessions combined with our nutritional plan will get you the results
        you seek provided you stick to our plan. The results we have seen in
        clients over the 10 weeks speak for themselves{" "}
      </h4>
      <ul>
